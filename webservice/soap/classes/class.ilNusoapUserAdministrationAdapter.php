...
class ilNusoapUserAdministrationAdapter 
{
	...
	function __registerMethods()
	{
		...
		$this->server->wsdl->addComplexType('SubjectArea',
			'complexType',
			'struct',
			'all',
			'',
		...
		$this->server->wsdl->addComplexType('SubjectAreas',
				'complexType',
				'array',
				'',
				'SOAP-ENC:Array',
		...
		$this->server->register('getSubjectAreas',
			array('sid' => 'xsd:string'),
		...
		// register getSubjectAreas
		$this->server->register('createTest',
		...
		$this->server->wsdl->addComplexType('QuestionOv',
			'complexType',
			'struct',
			'all',
			'',
		...
		$this->server->wsdl->addComplexType('QuestionOvs',
				'complexType',
				'array',
				'',
				'SOAP-ENC:Array',
		...
		$this->server->register('getQuestionOverview',
			array('sid' => 'xsd:string'),
		...
		$this->server->wsdl->addComplexType('Answer',
			'complexType',
			'struct',
			'all',
			'',
		...
		// array of answers
		$this->server->wsdl->addComplexType('Answers',
				'complexType',
				'array',
				'',
				'SOAP-ENC:Array',
		...
		$this->server->wsdl->addComplexType('Question',
			'complexType',
			'struct',
			'all',
			'',
		...
		$this->server->register('processQuestion',
			array('sid' => 'xsd:string', 'save_q_id' => 'xsd:int', 'given_answer' => 'xsd:int', 'req_q_id' => 'xsd:int'),
		...
		$this->server->wsdl->addComplexType('Result',
			'complexType',
			'struct',
			'all',
			'',
		...
		$this->server->wsdl->addComplexType('Results',
				'complexType',
				'array',
				'',
				'SOAP-ENC:Array',
		...
		// register finishTest
		$this->server->register('finishTest',
		...
		$this->server->register('getScoringSheet',
			array('sid' => 'xsd:string'),
		...
		$this->server->wsdl->addComplexType('InformationSheet',
			'complexType',
			'struct',
			'all',
			'',
		...
		$this->server->wsdl->addComplexType('InformationSheets',
				'complexType',
				'array',
				'',
				'SOAP-ENC:Array',
		...
		$this->server->register('getInformationSheets',
			array('sid' => 'xsd:string'),
		...
		// getHelpText
		$this->server->register('getHelpText',
								array(),
