...
class adnStatistics 
{
	...
	public static function getExtensionsRefresher(array $a_filter = null)
	{
		...
		return adnCertificate::getExtensionStatistics($a_filter["date"]["from"],
			$a_filter["date"]["to"], $a_filter["wmo"], $proofs);
	}
	...
	{
		include_once "Services/ADN/ES/classes/class.adnCertificate.php";
		return adnCertificate::getDuplicateStatistics($a_filter["date"]["from"],
			$a_filter["date"]["to"], $a_filter["wmo"]);
	}
	...
	{
		include_once "Services/ADN/ES/classes/class.adnCertificate.php";
		$res = adnCertificate::getTotalStatistics($a_filter["date"]["from"],
			$a_filter["date"]["to"], $a_filter["wmo"]);
	...
	public static function getCertificatesGasChem(array $a_filter = null)
	{
		...
		return adnCertificate::getTypeStatistics($a_filter["date"]["from"], $a_filter["date"]["to"],
			$a_filter["wmo"], $types);
	}
}
