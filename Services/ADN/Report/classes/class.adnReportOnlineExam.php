...
class adnReportOnlineExam extends adnReport
{
	...
	public function createSheets()
	{
		...
		{
			throw new adnReportException("Dieser Prüfung sind keine Antwortbögen zugeordnet.",
				$a_code);
		}
		...
		{
			throw new adnReportException("Dieser Prüfung sind keine Kandidaten zugeordnet.",
				$a_code);
		}
		...
		foreach($assignments as $ass)
		{
			...
			{
				throw new adnReportException("Einem Kandidaten (".$header.") sind keine Prüfungsbögen zugeordnet.",
					$a_code);
			}
			...
			{								
				...
				{
					throw new adnReportException("Es fehlen Fragen zu einen Prüfungsbogen.",
						$a_code);
				}
