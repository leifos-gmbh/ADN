...
class adnCertificate extends adnDBBase
{
	 ...
	 */
	static public function getProofTypes()
	{
		global $lng;
	 ...
	 */
	function getFullCertificateNumber()
	{
		return self::_getFullCertificateNumber(
			$this->getIssuedByWmo(), $this->getNumber(), $this->getIssuedOn());
	}
	 ...
	 * @return string full certificate number
	 */
	static function _getFullCertificateNumber($a_wmo_id, $a_number, $a_issued_on)
	{
	 ...
	 * @return array
	 */
	public static function getAllCertificates(array $a_filter = null,
		$a_with_invalid = false, $a_with_archived = false, $a_exclude_valids = false)
	{
		global $ilDB;
	...
	{
		return self::_determineNextNumber($this->getIssuedByWmo(),
			$this->getIssuedOn());
	}
	 ...
	 * @return int next number
	 */
	static function _determineNextNumber($a_issued_by_wmo, $a_issued_on)
	{
		global $ilDB;
	 ...
	 */
	static function countCertificatesForProfessional($a_cp_id)
	{
		global $ilDB;
	 ...
	 */
	public static function getExtensionStatistics(ilDateTime $a_from,
		ilDateTime $a_to, $a_wmo = null, array $a_proofs = null)
	{
		global $ilDB;
	 ...
	 */
	public static function getTypeStatistics(ilDateTime $a_from,
		ilDateTime $a_to, $a_wmo = null, array $a_types = null)
	{
		global $ilDB;
	 ...
	 */
	protected static function getStatisticsConditions(ilDateTime $a_from,
		ilDateTime $a_to, $a_is_duplicate = false, $a_restrict_to_issued = true, $a_tbl_prefix = '')
	{
		global $ilDB;
	 ...
	 */
	public static function getDuplicateStatistics(ilDateTime $a_from,
		ilDateTime $a_to, $a_wmo = null, $a_return_resultset = false)
	{
		global $ilDB;
