...
class adnExaminationEventTableGUI extends ilTable2GUI
{
	 ...
	 */
	function __construct($a_parent_obj, $a_parent_cmd, $a_mode, $a_archived = false)
	{
		global $ilCtrl, $lng;
	...
	function initFilter()
	{
		...
		// exam facility
		$facility = $this->addFilterItemByMetaType("facility", self::FILTER_SELECT, false,
	...
	protected function fillRow($a_set)
	{
		...
		switch($this->mode)
		{
			...
			case self::MODE_PREPARATION:
				...
				else if(adnPerm::check(adnPerm::EP, adnPerm::READ))
				{
					$this->tpl->setCurrentBlock("action");
			...
			case self::MODE_ASSIGNMENT:
				...
				else if(adnPerm::check(adnPerm::EP, adnPerm::READ) && $a_set["assigned"])
				{
