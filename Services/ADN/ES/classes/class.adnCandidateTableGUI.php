...
class adnCandidateTableGUI extends ilTable2GUI
{
	 ...
	 */
	function __construct($a_parent_obj, $a_parent_cmd, $a_event_id, $a_notification_mode = false)
	{
		global $ilCtrl, $lng;
	...
	protected function importData()
	{
		...
		$assignments = adnAssignment::getAllAssignments(
			array("event_id" => $this->event_id), array("first_name", "last_name", "birthdate",
				"blocked_until"));
	...
	protected function fillRow($a_set)
	{
		...
		// participated?
		$this->tpl->setVariable("VAL_PARTICIPATED",
