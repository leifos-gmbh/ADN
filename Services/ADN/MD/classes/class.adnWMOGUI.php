...
class adnWMOGUI
{
	...
	protected function listWMOs()
	{
		...
		if(adnPerm::check(adnPerm::MD, adnPerm::WRITE))
		{
			$ilToolbar->addButton($lng->txt("adn_add_wmo"),
	...
	protected function saveWMO()
	{
		...
		if($form->checkInput())
		{
			...
			$office->setCostCertificate($form->getInput("ccno"), $form->getInput("ccdesc"),
				$form->getInput("ccval"));
			$office->setCostDuplicate($form->getInput("cdno"), $form->getInput("cddesc"),
				$form->getInput("cdval"));
			$office->setCostExtension($form->getInput("ceno"), $form->getInput("cedesc"),
				$form->getInput("ceval"));
			$office->setCostExam($form->getInput("cxno"), $form->getInput("cxdesc"),
				$form->getInput("cxval"));
	...
	protected function updateWMO()
	{
		...
		if($form->checkInput())
		{
			...
			$this->office->setCostCertificate($form->getInput("ccno"), $form->getInput("ccdesc"),
				$form->getInput("ccval"));
			$this->office->setCostDuplicate($form->getInput("cdno"), $form->getInput("cddesc"),
				$form->getInput("cdval"));
			$this->office->setCostExtension($form->getInput("ceno"), $form->getInput("cedesc"),
				$form->getInput("ceval"));
