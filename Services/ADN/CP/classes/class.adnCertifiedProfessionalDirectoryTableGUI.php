...
class adnCertifiedProfessionalDirectoryTableGUI extends ilTable2GUI
{
	 ...
	 */
	function __construct($a_parent_obj, $a_parent_cmd, ilDate $a_date_from, ilDate $a_date_to, $a_wmo)
	{
		global $ilCtrl, $lng;
	...
	{
		include_once "Services/ADN/ES/classes/class.adnCertificate.php";
		$professionals = adnCertificate::getProfessionalDirectory($this->date_from, $this->date_to,
			$this->wmo);
