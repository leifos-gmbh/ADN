...
class adnTrainingEvent extends adnDBBase
{
	...
	protected function propertiesToFields()
	{
		$fields = array("ta_provider_id" => array("integer", $this->getProvider()),
			...
			"date_from" => array("text", $this->getDateFrom()->get(IL_CAL_DATE, "",
				ilTimeZone::UTC)),
	...
	public function delete()
	{
		...
		if($id)
		{
			...
			if($this->getDateTo()->get(IL_CAL_DATETIME, "",
				ilTimeZone::UTC) < date("Y-m-d 00:00:00"))
			{
	 ...
	 * @return array
	 */
	public static function getAllTrainingEvents($a_provider_id = false, $a_current = true,
		$a_filter = null, $a_with_archived = false)
	{
		global $ilDB;
