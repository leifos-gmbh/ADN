...
class adnSoapELearning  extends ilSoapAdministration
{
	 ...
	 */
	function createTest($sid, $a_sa_id)
	{
		$this->initAuth($sid);
		$this->initIlias();
	 ...
	 */
	function getQuestionOverview($sid)
	{
		$this->initAuth($sid);
		$this->initIlias();
	 ...
	 * @return array 
	 */
	function processQuestion($sid, $a_save_q_id, $a_given_answer, $a_req_q_id)
	{
		$this->initAuth($sid);
		$this->initIlias();
	 ...
	 * @return array 
	 */
	function finishTest($sid, $a_save_q_id, $a_given_answer)
	{
		$this->initAuth($sid);
		$this->initIlias();
	 ...
	 */
	function getInformationSheets($sid)
	{
		$this->initAuth($sid);
		$this->initIlias();
